package com.bghddevelopment.weather;

import com.bghddevelopment.weather.events.Events;
import com.bghddevelopment.weather.utilities.Color;
...
public class NoWeather extends JavaPlugin implements Listener {
    @Getter
    public static NoWeather plugin;

    public void onEnable() {
        NoWeather.plugin = this;
        PluginDescriptionFile VarUtilType = this.getDescription();
        getLogger().info("NoWeather V" + VarUtilType.getVersion() + " starting...");
        getServer().getPluginManager().registerEvents(new Events(), this);
        getLogger().info("NoWeather V" + VarUtilType.getVersion() + " started!");
    ...
    public void updateCheck(CommandSender sender, boolean console) {
        try {
            ...
            if (object.has("plugins")) {
                ...
                JsonObject info = plugins.get("NoWeather").getAsJsonObject();
                ...
                if (version.equals(getDescription().getVersion())) {
                    if (console) {
                        sender.sendMessage(Color.translate("&aNoWeather is on the latest version."));
                    }
                } else {
                    sender.sendMessage(Color.translate(""));
                    sender.sendMessage(Color.translate(""));
                    sender.sendMessage(Color.translate("&cYour NoWeather version is out of date!"));
